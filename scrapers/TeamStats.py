...
def get_team_stats(year, division):
    ...
    for stat_type in stat_types:
        team_stats_file_name = FileUtils.get_file_name(year, division, base_file_name.format(
                stat_type=stat_type))
    ...
    schools_file_name = FileUtils.get_file_name(year, division, 'schools')
    with open(schools_file_name, 'wb') as file:
        schools_writer = unicodecsv.writer(file)
        schools_writer.writerow(['school_name', 'school_id'])
        schools_writer.writerows(team_info)
