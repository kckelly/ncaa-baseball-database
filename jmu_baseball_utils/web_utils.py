...
def get_page(url: str, sleep_time: float, try_limit: int) -> BeautifulSoup:
    """
...
def get_school_id_from_url(url: str) -> str:
    """
...
def get_coach_id_from_url(url: str) -> str:
    """
...
def get_contest_id_from_url(url: str) -> str:
    """
