...
class NCAADatabase:
    ...
    def create_team(self, year, school_ncaa_id):
        """
        ...
        self.cursor.execute('INSERT INTO team(year, conference_id, school_id) '
                            ...
                            'RETURNING id;'.format(year=year, conference_id=self.get_default_conference_id(),
                                                   school_id=school_id))
    ...
    def get_game_lineup(self, game_id, side):
        """
